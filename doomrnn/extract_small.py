'''
saves ~ 10 episodes generated from a random policy (reduced version for testing)
'''
...
MAX_TRIALS = 10 # reduced for testing, original: 200
MIN_LENGTH = 100
...
for trial in range(MAX_TRIALS): # 10 trials for testing
  try:
